...
#'
#' @description Returns the possible model classes that \code{gglm} works with.
#'
...
#' \code{gglm} imports. For example, the model class "merMod" refers to a 
#' variety of model outputs from \code{lme4}, even when the outputted class is
#' not called "merMod". 
#' @return A character vector containing the possible model classes that 
#' \code{gglm} works with.
#' @examples
#' list_model_classes()
#' @export
